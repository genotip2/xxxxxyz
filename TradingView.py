...
# "smallest" = mulai dari pair dengan volume terkecil
ANALYSIS_ORDER = "smallest"
...
def update_pairs_cache():
    ...
    memfilter pair dengan target USDT, mengambil TOP_PAIRS_CACHED pair teratas berdasarkan volume trading,
    lalu menyimpannya ke file cache.
    """
    ...
    # Bentuk daftar pair dengan format "BASEUSDT" sesuai urutan volume terbesar ke terkecil
    pairs_list = [f"{ticker.get('base')}USDT" for ticker in top_pairs]
...
def main():
    ...
    # Karena cache disimpan dalam urutan dari volume terbesar ke terkecil:
    # - Jika "largest": ambil elemen pertama sejumlah PAIR_TO_ANALYZE
    # - Jika "smallest": ambil elemen terakhir sejumlah PAIR_TO_ANALYZE
